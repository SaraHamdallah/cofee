			...
			<div class="row">
				<div class="col-md-12 col-sm-12 ">
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
							<form action="{{ route('addCategory') }}"  method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							@csrf  <!-- creating input hidden token (secret code) -->
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="text" id="add-category" name="cat_name" value="{{ old('cat_name') }}" required="required" class="form-control ">
									</div>
								</div>
