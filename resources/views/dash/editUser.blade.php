        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form method="POST" action="{{ route('updateUser', $user->id) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        @method('put') <!-- to add the updated data only -->
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="flat" name="active" value="1" @if($user->active) checked @endif>
                                    </label>
                                </div>
                            </div>
                            <div class="item form-group">
